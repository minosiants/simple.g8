...
declare -r sbt_launch_ivy_release_repo="http://artifactory.daas.corp.telstra.com/artifactory/libs-release"
declare -r sbt_launch_ivy_snapshot_repo="https://repo.scala-sbt.org/scalasbt/ivy-snapshots"
declare -r sbt_launch_mvn_release_repo="http://artifactory.daas.corp.telstra.com/artifactory/libs-release"
declare -r sbt_launch_mvn_snapshot_repo="http://repo.scala-sbt.org/scalasbt/maven-snapshots"


declare -r default_jvm_opts_common="-Xms512m -Xmx1536m -Xss2m"
declare -r noshare_opts="-Dsbt.global.base=project/.sbtboot -Dsbt.boot.directory=project/.boot -Dsbt.ivy.home=project/.ivy -Dsbt.override.build.repos=true -Dsbt.repository.config=project/repositories.txt"
...
#sbt -Dsbt.override.build.repos=true -Dsbt.repository.config=project/repositories.txt
